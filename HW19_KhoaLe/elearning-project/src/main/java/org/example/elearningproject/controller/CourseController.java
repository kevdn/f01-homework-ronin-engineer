...
public class CourseController {
        ...
        public Object updateCourse(@PathVariable("course_id") String courseId,
            ...
            return courseService.updateCourse(courseId, courseUpdateReq, bindingResult);
        }

        @DeleteMapping(UrlConstant.COURSE_DELETE)
        public Object deleteCourse(@PathVariable("course_id") @NotBlank String courseId) {
        ...
        public Object getCourseDetail(@PathVariable("course_id") @NotBlank String courseId)
        {
