...
public class TeacherController {
        ...
        public Object updateTeacher(@PathVariable("teacher_id") @NotBlank  String teacherId,
                                    @RequestBody TeacherUpdateReq teacherUpdateReq,
                                    BindingResult bindingResult) {
            return teacherService.updateTeacher(teacherId, teacherUpdateReq, bindingResult);
        }

        @DeleteMapping(UrlConstant.TEACHER_DELETE)
        public Object removeTeacher(@PathVariable("teacher_id") @NotBlank String teacherId) {
        ...
        public Object getTeacherDetail(@PathVariable("teacher_id") @NotBlank  String teacherId)
        {
